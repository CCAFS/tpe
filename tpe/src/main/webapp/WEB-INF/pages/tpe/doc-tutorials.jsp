	...
	<div id="documentation">
		<div class="pane_left">
			...
			<div class="sec_details">
				...
				<h1>Audience</h1>
				<p>This tutorial has been prepared for the breeders, scientists,
				...
				<ul class="guide_list">
					<li><span class="item_bold">Home:</span> This contains the TPE
						overview and introduction</li>
					<li><span class="item_bold">TPE Tool:</span> This provides the
						TPE Tool and all the controls used.</li>
				...
				<p>Click Home on the main menu bar. The home page(figure 1) will
					be displayed. The home page has a number sections:</p>
				<ul class="guide_list">
					...
					<li><span class="item_bold">TPE Tool:</span> This section
						...
						automatically display the TPE Tool's page(figure x). The same page
						is also accessible by clicking on TPE Tool menu located on the
						main menu bar (figure xx).</li>
				...
				<p>On the Home screen, click on the Get Involved section to go
					...
					Involved page (figure 12), which clearly explains how you could get
				...
				<ul class="guide_list">
					<li>On the Select Variable Pane, select your desired output
						...
						<span class="item_bold">Climate</span> and <span class="item_bold">Soil</span>).
					</li>
					...
					<li>Hover or click on the TPE regions (environments), to view
						...
						info window. The info window shows the details about the currently
						hovered or clicked region.</li>
				</ul>
				<div class="guide-big">
				...
				<ul class="guide_list">
					...
					<li>Click on the download icon to download or export the
						graphic in different formats (PNG, JPG, PDF and SVG vetcor image).<img
						alt="tpe-tool" src="img/download_32.png">
					</li>
					<li></li>
				</ul>
