			...
			<div class="pane_left">
				<div class="tpe_sec">
					...
					<div class="news-min">
						<h4>
							<a target="_blank"
								href="http://dapa.ciat.cgiar.org/working-on-target-population-of-environments-tpe-identification-for-rice-and-beans-in-colombia-and-brazil/">Working
								on Target Population of Environments (TPE) identification for
								Rice and Beans in Colombia and Brazil</a>
						</h4>
				...
				<div class="tpe_sec">
					...
					<div class="news-min">
						<h4>
							<a target="_blank"
								href="http://ccafs.cgiar.org/blog/steadying-aim-crop-breeders-using-target-population-environments#.VMK5PUfF9Rs">Steadying
								the aim for crop breeders using target population environments</a>
						</h4>
						<p>There's no such thing as a compass for climate change, for
							...
							exactly? For most crop breeding programs, the customary answer to
							that question has always been the same: cultivars with a)
							improved potential production, b) resistance to pests, or c)
