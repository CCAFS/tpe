		...
		<div>
			<div class="pane_left">
				...
				<div class="case-list ">
						...
						<p>The upland rice (UR) breeding program strategy is to
							perform direct grain yield selection in optimal growing
							conditions. Drought stress conditions, however, are prevalent
							across central Brazil, and hence limit the efficiency of the UR
							breeding program. We analyzed these drought conditions across the
							UR growing region.</p>

						<img
							src="https://www.flickr.com/photos/ciat/5853384737/in/photolist-9Vf8mv-9Vf7WT-9VhZtJ-bAFHw6-aC23h6-9ktB4v-7AhyL3-9kwyy1-9kwxP7-9kwxVd-9kwzXf-9kwF6L-9ktCLM-9kwHWd-9kxRfb-8F9RkM-8F9Vyi-9kwEfm-kTF5w3-9ktEND-71fsrp-71fsik-7AdS9V-9ktBck-9kxPQy-fKca9X-8CTBYS-7AdKvn-7ygYut-7ykNfS-7ykNdo-7ygYsp-afXpiT-nXhzNj-q5Xs1d-7a12jW-6odMrx-7AdS6z-9Ezk9F-kTynTn-9Ezjtc-9ECeXd-8CTBKC-8CQwEt-8CQwr4-8CQwi4-7ykN15-kTB1Fg-kTBR6v-kTBUEr"
							alt="image" />
						...
						<div class="img"><img src="${ctx}/resources/rice_EG_map.jpg" alt="image" /></div>
						<p>Environmental groups for upland rice in central Brazil. The
							map shows the the most frequent EG. Blue corresponds to the
							highly favorable environment (HFE); yellow corresponds to the
							favorable environment (FE); and beige corresponds to the least
							favorable environment (LFE).</p>
						...
						<img src="${ctx}/resources/rice_profiles.jpg" alt="image" />
						<p>Drought stress patterns for each upland rice EG. HFE:
							highly favorable environment; FE: favorable environment; and LFE:
							least favorable environment. Stress types for each environment
							with numbers representing the frequency of occurrence of stress
						...
						<ul>
							<li>In the best environment (HFE, 19 % occurrence), the
								...
								Santo Antonio de Goiás nursery is likely to perform well.</li>
						...
						<p>Based on our analyses, we estimate that a four-fold
							increase in the coverage of the UR breeding program is possible
							if breeding targeted specific selection in drought environments.
							Realising this potential, however, will ultimately depend on the
							existence and efficiency of seed systems, and on the adoption
							barriers to new germplasm.</p>
						...
						<ul>
							...
							<li>Heinemann AB, Barrios-Perez C, Ramirez-Villegas J, et
								al. (2015) Variation and impact of drought-stress patterns
								across upland rice target population of environments in Brazil.
								Journal of Experimental Botany 66:3625–3638. doi:
								10.1093/jxb/erv126 read <a
								href="http://jxb.oxfordjournals.org/content/66/12/3625">rice
									paper</a>
							</li>
						</ul>
				</div>
				...
				<div class="case-list">
						<h1 id="common-beans-casestudy">Common beans in Goiás, Brazil</h1>
						<p>In the state of Goiás, common bean production occurs in
							three growing seasons or `zafras`. A first season (wet season)
							for which sowing occurs between 1st Nov. and 31st Dec.; a second
							...
							adjusted.</p>
						<img
							src="https://www.flickr.com/photos/ciat/6887916980/in/photolist-7fHmCr-7gQqU8-7fMMB1-7fN2yK-7fMX1r-8Zthyh-buEnKj-7g2rqv-de2bji-zdFyYm-72ukym-aWaWfT-9ifYYG-7fJj66-7g2qU6-7g2r3B-6FCSaS-72qevi-7g6v6C-7fKSwa-9icR9V-8djBHS-8djBZb-8djBQU-7g6nL9-aWaWH2-7g2oDP-7g6j9d-7fNgVQ-zdFxSd-aWaUvg-9VfbUe-aWaUbz-zsZPNC-aWaU9z-aWaUeH-7fN9be-9ifSvj-9ifT2b-8dgmj2-r3BZ9M-aWaWii-7g2o4c-zt1enS-yyqJXR-aWaVT8-aWaVEi-aWaTLr-9icPDk-aWaVzH"
							alt="image" />
						<p>Using the DSSAT model for the varieties Pérola and BRS
							Radiante, we found the following environments for the two growing
							seasons (see maps below):</p>
						<ul>
							<li>For the wet season (top maps), two different EGs exist:
								a highly favorable environment (HFEw, 44 % occurrence, mean
								yield of 3,655 kg/ha) and a favorable environment (FEw, 56 %
							...
							<li>For the dry season (bottom maps), we also find two EGs:
								...
								favorable environment (FEd, 42 % occurrence). Yields in HFEd
								were roughly twice as large as in FEd (i.e. 2,781 vs. 1,356 kg
								ha-1).</li>
						</ul>
						<img src="${ctx}/resources/environmental_groups_beans.png"
							alt="image" />
						<p>Maps of environmental groups for the dry bean wet (top
							maps) and dry (bottom maps) seasons in Goiás, Brazil. The left
							maps show the the most frequent EG for early planting (i.e.
							during Nov. for the wet season and during Jan. for the dry
							season), and the right maps show the most frequent EG for late
							planting (i.e. during Dec. for the wet season and Feb. for the
							dry season).</p>
						...
						<ul>
							...
							<li>For the favorable environment in the wet season FEw,
								...
								% of the times.</li>
							<li>For the dry season, HFEd consists of two stress
								profiles: [1] stress-free conditions, which occurs 79-80 % of
								the time depending on the cultivar; and [2]
								terminal-reproductive drought stress, which occurs 20-21 % of
								the time depending on the cultivar.</li>
						...
						<img src="${ctx}/resources/bean_dry_profile_bottom_panel.tiff"
							alt="image" /> <img
							src="${ctx}/resources/bean_dry_profile_bottom_panel.tiff"
							alt="image" />
						<p>Drought stress patterns for favorable environment (FE) and
							highly favorable environment (HFE) for wet (top) and dry (bottom)
							common beans growing seasons and for both Pérola and BRS Radiante
							cultivars.</p>
						<p>In the rainfed seasons, drought-stress conditions occur
							about 25 % of the time for both cultivars Pérola and BRS
							Radiante. For the common bean breeding program, a 25 % frequency
							of occurrence of moderate drought means that germplasm selection
						...
						<ul>
							...
							<li>Heinemann AB, Ramirez-Villegas J, Souza T, et al.
								(2015b) Drought impact on rainfed common bean production areas
								in Brazil. Agricultural and Forest Meteorology. under review.</li>
						</ul>
				</div>
			</div>
